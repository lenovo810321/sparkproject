...
/**
 * 检验工具类
 * 主要是校验数据中的指定字段是否在指定范围内以及是否有参数字段的值相同等功能
...
public class ValidUtils {
     ...
     * @return 校验结果
     */
    public static boolean equal(String data, String dataField, String paramter, String paramField) {

        String paramFieldValue = StringUtils.getFieldFromConcatString(paramter, "\\|", paramField);
        if (paramFieldValue == null) {
            return true;
        }
